            ...
            <div className={`hidden semi-topbar rounded-md px-3 mt-2 md:flex bg-[#4a6cf7] text-white justify-between items-center `}>
              ...
              <div className="flex items-center py-2">
                <a
                  ...
                  className="mr-6 text-white duration-300 hover:text-white dark:text-body-color-white dark:hover:text-white"
                >
                  <svg
                    width="20"
                    height="20"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white duration-300 hover:text-white dark:text-body-color-white dark:hover:text-white"
                >
                  <svg
                    width="20"
                    height="19"
