...
const index = () => {
  return (
    <>
      <Breadcrumb
        pageName="Coconut Shell Pellets Activated Carbon"
                ...
                <table className="table-auto w-[100%] border-collapse border border-gray-200">
                  <thead>
                    <tr className="bg-primary text-white">
                      ...
                      <th className="border border-gray-300 p-4 text-left" colSpan={5}>Coconut Shell Pellets Activated Carbon</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 p-4">≥60</td>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 p-4">450-520</td>
                      <td className="border border-gray-300 p-4">430</td>
                    </tr>
                  </tbody>
                </table>
              </div>
